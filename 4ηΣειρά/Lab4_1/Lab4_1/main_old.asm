...
ldi r24 ,(0<<CS12) | (1<<CS11) | (1<<CS10) ; CK/64
out TCCR1B ,r24

ldi r24,0xCF ; initialize TCNT1
...
skip_print_clear:
ldi r19,0x00
or r18, r28 ; also consider PB7
out PORTB, r18 ;print gas level
...
ldi r19, 0x01
inc r17
cpi r17,0x06 ;for the first 5*0.1=0.5s led's ob then off
brsh blink_off
